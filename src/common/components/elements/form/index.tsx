import { Typography, Box, Stack, TextField, FormControl, RadioGroup, FormControlLabel, Radio, Button} from "@mui/material"
import React from "react"
import * as Yup from "yup"
import { useFormik, Form, FormikProvider } from "formik"
import { initialValues } from "./types"
import { useAppDispatch } from "../../../hooks"
import { changeGender, clearBodyData, saveBodyData} from "../../../../redux/reducers/bodyFatCalc.slice"
...
export const FormBodyFatCalculator: React.FunctionComponent = () => {
  ...
  const formSchema = Yup.object().shape({
    gender: Yup.string().required("Up`s, se requiere el género"),
    height: Yup.number()
      .required("Up`s, se requiere la altura")
      .min(2, "Debe ser un mínimo de 2"),
    weight: Yup.number()
      .required("Up`s, se requiere el peso")
      .typeError("Solo un número")
      .min(2, "Debe ser un mayor de 2"),
    waist: Yup.number()
      .required("Up`s, se requiere la medida de la cintura")
      .typeError("Solo un número")
      .min(2, "Debe ser un mayor de 2"),
    neck: Yup.number()
      .required("Up`s, se requiere la medida del cuello")
      .typeError("Solo un número")
      .min(2, "Debe ser un mayor de 2"),
